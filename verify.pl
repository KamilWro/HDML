...
:- use_module('kamil_breczko_parser.pl'). % rozwiązanie pracowni 3
...
:- use_module('kamil_breczko_solver.pl').     % rozwiązanie pracowni 1
%:- use_module('kamil_breczko_prover.pl'). % rozwiązanie pracowni 2
